...
// Imagen is an evidence/photo attached to a venta. It is a child entity of
// the Venta aggregate root; new images are added via Venta.AdjuntarImagen
// and removed via Venta.EliminarImagen.
type Imagen struct {
	id          uuid.UUID
