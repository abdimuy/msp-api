...
type VentaDTO struct {
	...
	NombreClienteMicrosip  *string            `json:"nombre_cliente_microsip,omitempty"  doc:"nombre actual del cliente en Microsip; ausente cuando no hay cliente vinculado o no se pudo resolver"`
