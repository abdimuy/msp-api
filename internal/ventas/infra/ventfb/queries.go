...
const selectClienteEstatus = `SELECT FIRST 1 ESTATUS FROM CLIENTES WHERE CLIENTE_ID = ?`

const selectClienteNombre = `SELECT FIRST 1 NOMBRE FROM CLIENTES WHERE CLIENTE_ID = ?`
