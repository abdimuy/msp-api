...
func defaultInput(nombre string) outbound.MicrosipClienteInput {
	return outbound.MicrosipClienteInput{
		...
		CobradorID:              11502,
		VendedorID:              88266,
		CiudadID:                microsip.DefaultCiudadID,
		EstadoID:                microsip.DefaultEstadoID,
		PaisID:                  microsip.DefaultPaisID,
		CondPagoID:              microsip.DefaultCondPagoID,
		TipoClienteID:           microsip.DefaultTipoClienteID,
		MonedaID:                microsip.DefaultMonedaID,
		ViaEmbarqueID:           microsip.DefaultViaEmbarqueID,
		ComprobanteDomicilioID:  microsip.DefaultComprobanteDomicilioID,
		IdentificacionOficialID: microsip.DefaultIdentificacionOficialID,
	}
}
