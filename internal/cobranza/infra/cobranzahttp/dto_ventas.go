...
type SyncVentasInput struct {
	...
	Desde   string `query:"desde"                               doc:"Ventana absoluta (YYYY-MM-DD o RFC3339 UTC). Incluye las ventas saldadas con FECHA_ULT_PAGO >= desde. Si se omite, el servidor aplica su ventana por defecto (7 días); no existe la opción sin ventana"`
}
