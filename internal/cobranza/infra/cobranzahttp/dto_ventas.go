...
type SyncVentasInput struct {
	...
	Desde   string `query:"desde"                               doc:"Ventana absoluta en RFC3339 (instante; p. ej. 2026-08-20T06:00:00Z = medianoche en CDMX). Incluye las ventas saldadas con FECHA_ULT_PAGO >= desde. Si se omite, el servidor aplica su ventana por defecto (7 días); no existe la opción sin ventana"`
}
