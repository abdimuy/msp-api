...
func drawWatermark(pdf *fpdf.Fpdf, gen time.Time, generadoPor string) {
	...
	// A SINGLE centred diagonal, drawn on top of the body (footer hook in
	// Render) so it stays visible over cards and text. Low alpha keeps the text
	// underneath fully readable; one mark, not a tiled pattern.
