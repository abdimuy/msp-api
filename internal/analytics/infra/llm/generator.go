...
La acción de cierre DEBE respetar el riesgo de crédito: si el crédito es de riesgo alto o crítico, o el cliente está moroso, prioriza la cobranza o la recuperación del saldo y NO recomiendes venderle más ni ofrecerle promociones a crédito; reserva las acciones de venta o recompra para cuando el crédito esté sano.
