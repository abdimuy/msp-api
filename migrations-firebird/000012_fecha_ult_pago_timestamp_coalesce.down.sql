-- ============================================================================
-- Rollback de la migración 000012: volver FECHA_ULT_PAGO a DATE y procedure
-- sin LEFT JOIN.
-- ============================================================================
...
ALTER TABLE MSP_SALDOS_VENTAS ALTER COLUMN FECHA_ULT_PAGO TYPE DATE;
COMMIT;

CREATE INDEX IDX_MSP_SALDOS_ZONA_FUP ON MSP_SALDOS_VENTAS (ZONA_CLIENTE_ID, FECHA_ULT_PAGO);
COMMIT;

DROP INDEX IDX_MSP_PAGOS_RECIBIDOS_DOCTO_CC;
COMMIT;

DELETE FROM MSP_MIGRATIONS WHERE ID = 12;
COMMIT;
