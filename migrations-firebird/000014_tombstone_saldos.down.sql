-- ============================================================================
-- Rollback de la migración 000014: revertir tombstones a DELETE
-- ============================================================================
-- Restaura el body del procedure de 000012 (DELETE en cancelaciones) y borra
-- los tombstones existentes del caché para que la BD quede igual que antes
-- de aplicar 000014.
-- ============================================================================

-- Borrar tombstones existentes (rows con CARGO_CANCELADO='S').
DELETE FROM MSP_SALDOS_VENTAS WHERE CARGO_CANCELADO = 'S';
COMMIT;
...
DELETE FROM MSP_MIGRATIONS WHERE ID = 14;
COMMIT;
