...
func appOptions() []fx.Option {
	return []fx.Option{
		fx.Provide(
			...
			provideVentasZonaNombreResolver,
			provideVentasFaseResolver,
			provideVentasImageProcessor,
			provideVentasAplicarConfig,
			provideVentasMicrosipWriter,
			provideVentasMicrosipClienteWriter,
			provideVentasSearchIndex,
			provideVentasVendedoresRoster,
			provideVentasUsuarioEmailResolver,
			provideVentasReindexHandlers,
			provideVentasReconcileWorker,
			...
			// Clients hub module.
			provideClientesRepo,
			provideClientesClock,
			provideClientesAnalyticsClient,
			...
			provideReactivacionMensajeRepo,
			provideReactivacionClock,
			provideReactivacionTxRunner,
			provideReactivacionSender,
			provideReactivacionRand,
			provideReactivacionGobernador,
			provideReactivacionOpener,
			provideReactivacionCopilotoRepo,
			provideReactivacionConversacionRepo,
			provideReactivacionDecisionRepo,
			provideReactivacionNotaReader,
			provideReactivacionClienteFactsReader,
			provideReactivacionCategoriasClienteReader,
			provideReactivacionCopilotoLLM,
			provideReactivacionNBPReader,
			provideReactivacionService,
			provideReactivacionEnvioWorker,
			...
			// Flota module — bitácora de asignaciones de camioneta.
			provideFlotaRepo,
			provideFlotaTxRunner,
			provideFlotaClock,
			provideFlotaRosterReader,
			provideFlotaService,
			provideFlotaSnapshotWorker,
			// Visitas module.
			provideVisitasClock,
			provideVisitasRepo,
			provideVisitasService,
			provideRootHandler,
			provideHTTPServer,
		),
		fx.Invoke(
			...
			registerVentasSearchBootstrapLifecycle,
			registerVentasReconcileWorkerLifecycle,
			registerReactivacionEnvioWorkerLifecycle,
			registerFlotaSnapshotWorkerLifecycle,
